---
head.description: 'Register over temaer, info om søking og om de som har æren for nettstedets eksistens.'
---
...
### Kristi brudekammer
Se Luthers udlægning af evangeliet den [3.søndag efter treenigheden](aricle/trefoldighed/sommer/3-evangelium#kristi-brudekammer).

### Samvittighed
Ved at bruge samvittighed som søgeord, finder du meget opbyggelig læsestof. Se især evangeliet på [Helligtrekongersdag](articles/vinter/jul/helligtrekonger-evangelium), som nævner ordet samvittighed 39 gange.
...
::::TabItem{name="Ide"}
Formålet og ideen bak dette nettstedet er egosistiske da jeg først og fremst har tenkt på meg selv, at jeg selv kan ha noe verdifult å arbejde med, at jeg kan studere og lese i Guds ord via et responsivt webdesign. Videre kan det være ønskelig med register og oversikt over viktige emner i kirkepostillen og andre Luther-skrifter.
...
[_Jan-Vidar Steinsik_](https://w2.brreg.no/enhet/sok/detalj.jsp?orgnr=930018821), redaktørens mest gudfryktige venn, har æren for å ha tjent Gud ved sin munn og gitt tro og styrke ved ved sin tale og lesning av Guds ord, slik at Gud har gitt redaktøren mot til å ta fatt på dette prosjektet og til å fortsette med arbeidet gjennom kors og motgang.

Redaktøren av nettstedet [_www.lutherdansk.dk_](http://www.lutherdansk.dk/KP%20-%20enkeltpr%C3%A6dikener/KP%20-%20Forside%20med%20indeks/index.htm) (prest _Finn B. Andersen_), har hovedæren for det danske innholdet i kirkepostillen.

[_Benbinbin_](https://github.com/Benbinbin) bak nuxt-temaet [_BlogiNote_](https://github.com/Benbinbin/BlogiNote) har æren for meget god og avansert brukergrensesnitt.

[_CloudCannon_](https://github.com/CloudCannon) bak søke biblioteket [_Pagefind_](https://pagefind.app/), har æren for søkefunksjonaliteten på nettstedet.

[_Nuxt_](https://nuxt.com/), [_GitHub_](https://github.com) og [_Vercel_](https://vercel.com/docs/concepts/deployments/git/vercel-for-github) har æren for rammeverk, programmeringsmiljø og utplassering av nettsider.

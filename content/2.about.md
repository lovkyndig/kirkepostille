...
`Sesong`: [Advent](list?series=Advent), [Jul](list?series=Jul), [Åpenbaringstid](list?series=Aabenbaringstid), [Før-faste](list?series=For-faste), [Faste](list?series=Faste), [Påskeuka](list?series=Paaskeuka), [Påskedagene](list?series=Paaske), [Efter-påske](list?series=Efter-paaske), [Pinse](list?series=Pinse), [Sommer](list?series=Sommer) og [Høst](list?series=Host).  

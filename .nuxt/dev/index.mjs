globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://E:/Github/kirkepostille/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://E:/Github/kirkepostille/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, getQuery, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, appendHeader } from 'file://E:/Github/kirkepostille/node_modules/h3/dist/index.mjs';
import { SitemapStream, streamToPromise } from 'file://E:/Github/kirkepostille/node_modules/sitemap/dist/index.js';
import { Feed } from 'file://E:/Github/kirkepostille/node_modules/feed/lib/feed.js';
import { createRenderer } from 'file://E:/Github/kirkepostille/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://E:/Github/kirkepostille/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://E:/Github/kirkepostille/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://E:/Github/kirkepostille/node_modules/ofetch/dist/node.mjs';
import destr from 'file://E:/Github/kirkepostille/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://E:/Github/kirkepostille/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/Github/kirkepostille/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file://E:/Github/kirkepostille/node_modules/scule/dist/index.mjs';
import { hash } from 'file://E:/Github/kirkepostille/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file://E:/Github/kirkepostille/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://E:/Github/kirkepostille/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/Github/kirkepostille/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file://E:/Github/kirkepostille/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/Github/kirkepostille/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file://E:/Github/kirkepostille/node_modules/pathe/dist/index.mjs';
import { unified } from 'file://E:/Github/kirkepostille/node_modules/unified/index.js';
import { toString } from 'file://E:/Github/kirkepostille/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file://E:/Github/kirkepostille/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file://E:/Github/kirkepostille/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file://E:/Github/kirkepostille/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file://E:/Github/kirkepostille/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file://E:/Github/kirkepostille/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file://E:/Github/kirkepostille/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file://E:/Github/kirkepostille/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file://E:/Github/kirkepostille/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file://E:/Github/kirkepostille/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file://E:/Github/kirkepostille/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file://E:/Github/kirkepostille/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file://E:/Github/kirkepostille/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file://E:/Github/kirkepostille/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file://E:/Github/kirkepostille/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file://E:/Github/kirkepostille/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file://E:/Github/kirkepostille/node_modules/remark-parse/index.js';
import remark2rehype from 'file://E:/Github/kirkepostille/node_modules/remark-rehype/index.js';
import { all } from 'file://E:/Github/kirkepostille/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file://E:/Github/kirkepostille/node_modules/detab/index.js';
import { u } from 'file://E:/Github/kirkepostille/node_modules/unist-builder/index.js';
import { encode } from 'file://E:/Github/kirkepostille/node_modules/mdurl/index.js';
import slugify from 'file://E:/Github/kirkepostille/node_modules/slugify/slugify.js';
import { position } from 'file://E:/Github/kirkepostille/node_modules/unist-util-position/index.js';
import { visit } from 'file://E:/Github/kirkepostille/node_modules/unist-util-visit/index.js';
import { BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file://E:/Github/kirkepostille/node_modules/shiki-es/dist/shiki.node.mjs';
import consola from 'file://E:/Github/kirkepostille/node_modules/unenv/runtime/npm/consola.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"hostname":"https://kirkepostille.vercel.app","content":{"locales":[],"defaultLocale":"","integrity":"","experimental":{"stripQueryParameters":false,"clientDB":false},"api":{"baseURL":"/api/_content"},"navigation":{"fields":["_id","_type","series","tags"]},"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"highlight":{"theme":"one-dark-pro","preload":["vue","python"]},"wsUrl":"ws://localhost:4000/","documentDriven":false,"host":"","trailingSlash":false,"anchorLinks":{"depth":4,"exclude":[1]}}},"rss":{"title":"kirkepostil","description":"⚡ Search after words in Church-Postil by Dr. Martin Luther","image":"https://kirkepostille.vercel.app/default-avatar.png","favicon":"https://kirkepostille.vercel.app/default-favicon.ico","copyright":"Copyright 2023 lovkyndig"},"content":{"cacheVersion":2,"cacheIntegrity":"GU0RaMzkvP","transformers":[],"base":"","api":{"baseURL":"/api/_content"},"watch":{"ws":{"port":{"port":4000,"portRange":[4000,4040]},"hostname":"localhost","showURL":false}},"sources":{},"ignores":["\\.","-"],"locales":[],"defaultLocale":"","highlight":{"theme":"one-dark-pro","preload":["vue","python"]},"markdown":{"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"anchorLinks":{"depth":4,"exclude":[1]},"toc":{"depth":5,"searchDepth":5},"remarkPlugins":{"remark-math":{},"remark-sub":{},"remark-super":{},"remark-critic-markup":{}},"rehypePlugins":{"rehype-katex":{"output":"htmlAndMathml"}}},"yaml":{},"csv":{"delimeter":",","json":true},"navigation":{"fields":["_id","_type","series","tags"]},"documentDriven":false,"experimental":{"clientDB":false,"stripQueryParameters":false}}};
...
const serverAssets = [{"baseName":"server","dir":"E:/Github/kirkepostille/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"E:\\Github\\kirkepostille\\content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\Github\\kirkepostille\\.nuxt\\content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\Github\\kirkepostille","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\Github\\kirkepostille\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\Github\\kirkepostille\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\Github\\kirkepostille\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file://E:/Github/kirkepostille/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _c8vMAt = defineEventHandler(async (event) => {
...
const _J1T98Y = defineEventHandler(async (event) => {
...
const _RLmZX6 = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_CqJRme = () => Promise.resolve().then(function () { return pageview$1; });
const _lazy_pW8taW = () => Promise.resolve().then(function () { return sitemap_xml$1; });
const _lazy_zgmfig = () => Promise.resolve().then(function () { return rss_xml$1; });
const _lazy_Ij6gRa = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/pageview', handler: _lazy_CqJRme, lazy: true, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _lazy_pW8taW, lazy: true, middleware: false, method: undefined },
  { route: '/rss.xml', handler: _lazy_zgmfig, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Ij6gRa, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _c8vMAt, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _c8vMAt, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _c8vMAt, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _J1T98Y, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _RLmZX6, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _RLmZX6, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _RLmZX6, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_Ij6gRa, lazy: true, middleware: false, method: undefined }
];
...
const sitemap_xml = defineEventHandler(async (event) => {
  ...
  const articles = docs.filter((doc) => (doc == null ? void 0 : doc._type) === "markdown");
...
const getClientManifest = () => import('file://E:/Github/kirkepostille/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://E:/Github/kirkepostille/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"google-site-verification\" content=\"OBR08WFLQQiJUKuLzi19h9dr7I99cVDn5UzDi9mAjwA\">\n<script src=\"https://www.googletagmanager.com/gtag/js?id=G-J0PRB7L04Q\" async=\"\"></script>\n<script>\n          window.dataLayer = window.dataLayer || [];\n          function gtag(){dataLayer.push(arguments);}\n          gtag('js', new Date());\n          gtag('config', 'G-J0PRB7L04Q');\n          </script>","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
